...
namespace Multimorphic.P3SA.GUI {
	public class P3SASceneController : SceneController {
        ...
        public override void Start() {
            ...
            IntroActive = false;
            noCreditCount = 0;
            if (P3SAAudio.Instance != null)
            {
                P3SAAudio.Instance.StopAllPlaylists();
                P3SAAudio.Instance.ChangePlaylistByName("BG_Mode_Introduction");
            }
		}
		...
		public void ScoringXEventHandler(string eventName, object eventObject) {
			P3SAAudio.Instance.PlaySound3D("2X_Scoring", gameObject.transform);
			//P3SAAudio.Instance.ChangePlaylistByName("Multiball");
		...
		public void CreditAddedEventHandler(string eventName, object eventObject) {
			P3SAAudio.Instance.PlaySound3D("Credits_New_Credit", gameObject.transform);
		}

		public void CoinAddedEventHandler(string eventName, object eventObject) {
			P3SAAudio.Instance.PlaySound3D("AddMoneyPartialCredit", gameObject.transform);
		}

		public void NoCreditEventHandler(string eventName, object eventObject) {
			if (noCreditCount < 3) {
				P3SAAudio.Instance.PlaySound3D("Credits_No_Credit", gameObject.transform);
				noCreditCount++;
			}
		}

		public void BallLaunchedEventHandler(string eventName, object eventObject) {
			P3SAAudio.Instance.PlaySound3D("Ball_Launch", gameObject.transform);
		}
		...
		public void ShowPlayerRemovedEventHandler(string eventName, object eventObject) {
			string name = (string)eventObject;
			Destroy(addedPlayerObject);
			P3SAAudio.Instance.PlaySound3D("PlayerRemoved", gameObject.transform);
		...
		public void LeftRampHitEventHandler(string eventName, object eventData) {
			...
			P3SAAudio.Instance.PlaySound3D("Right_Ramp", gameObject.transform);
		}
		...
		public void NullTargetHitEventHandler(string eventName, object eventData) {
			P3SAAudio.Instance.PlaySound3D("ModeNullHit", gameObject.transform);
		}
		...
		public void AwardRespawnEventHandler(string evtName, object evtData) {
			...
			P3SAAudio.Instance.PlaySound3D("ScoopAwardRespawn", gameObject.transform);
		}
		...
		public void ShowConfirmationBoxEventHandler(string eventName, object eventData) {
			if (confirmationBox == null) {
				P3SAAudio.Instance.PlaySound3D("ConfirmationPopup", gameObject.transform);
			...
			Multimorphic.P3App.Logging.Logger.Log ("P3SA left highlight: " + data.leftHighlight.ToString());
		...
		public void DeleteProfileEventHandler(string eventName, object eventData) {
			P3SAAudio.Instance.PlaySound3D("ProfileDeleted", gameObject.transform);
		}

		public void CreateProfileEventHandler(string eventName, object eventData) {
			P3SAAudio.Instance.PlaySound3D("ProfileCreated", gameObject.transform);
		}

		public void TeamGameEnabledEventHandler(string eventName, object eventData) {
			if ((bool)eventData)
				P3SAAudio.Instance.PlaySound3D("TeamGameEnabled", gameObject.transform);
			else
				P3SAAudio.Instance.PlaySound3D("TeamGameDisabled", gameObject.transform);
		}
		...
		public void HighScoreAchievedEventHandler(string eventName, object eventData) {
			...
			{
				P3SAAudio.Instance.ChangePlaylistByName("HighScoreEntry");
//				highScoreBackground = (GameObject)Instantiate(Resources.Load("Prefabs/Framework/HighScore"));
		...
		public void CheaterEventHandler(string eventName, object eventData) {
            if (P3SAAudio.Instance)
                P3SAAudio.Instance.PlaySound3D("Cheater", gameObject.transform);
		}
        ...
        public void EnableReverseFlippersEventHandler(string eventName, object eventData)
        {
            ...
            P3SAAudio.Instance.PlaySound("FX/Reverse_flippers");
        }

        public void DisableReverseFlippersEventHandler(string eventName, object eventData)
        {
            P3SAAudio.Instance.PlaySound("FX/Regular_flippers");
        }
        ...
        public void EnableInvertFlippersEventHandler(string eventName, object eventData)
        {
            ...
            P3SAAudio.Instance.PlaySound("FX/Invert_flippers");
        }
