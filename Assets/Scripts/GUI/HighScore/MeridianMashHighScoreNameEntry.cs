...
namespace MeridianPinballClub.MeridianMash.GUI {
	...
	public class MeridianMashHighScoreNameEntry : Multimorphic.P3App.GUI.TextEditor {
...
//				splash.SetActive(false);
		...
		public override void Update() {
			...
			if (textSelector != null) {
				MeridianMashTextSelector selector = textSelector as MeridianMashTextSelector;
