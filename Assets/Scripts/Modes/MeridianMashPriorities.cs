...
namespace MeridianPinballClub.MeridianMash.Modes
{
	...
	/// </summary>
	public static class MeridianMashPriorities
	{
        ...
        public const int PRIORITY_EVENT_NAME_EDITOR = MeridianMashPriorities.PRIORITY_TEXT_EDITOR + 1;
		public const int PRIORITY_HIGH_SCORE_NAME_SELECTOR = MeridianMashPriorities.PRIORITY_TEXT_EDITOR + 2;
