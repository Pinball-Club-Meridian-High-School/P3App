...
{
	public class MeridianMashStatisticsMode : StatisticsMode
	{
		public MeridianMashStatisticsMode (P3Controller controller, int priority)
			: base(controller, priority)
		{
			Setup ();
		}

		public MeridianMashStatisticsMode (P3Controller controller, int priority, string eventName, string eventDir)
