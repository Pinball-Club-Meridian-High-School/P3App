...
namespace MeridianPinballClub.P3SA.Modes.Data
{
	...
	{
		public P3SAStatisticsMode (P3Controller controller, int priority)
			: base(controller, priority)
		{
			Setup ();
		}

		public P3SAStatisticsMode (P3Controller controller, int priority, string eventName, string eventDir)
