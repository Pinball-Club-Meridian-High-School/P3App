...
{
	public class MeridianMashHighScoresMode : HighScoresMode
	{
		private const int DATA_VERSION = 7;
		private const int DB_VERSION = 4;
		private List<HighScoreCategory> categories;

		public MeridianMashHighScoresMode (P3Controller controller, int priority)
		...
		public MeridianMashHighScoresMode (P3Controller controller, int priority, string eventName, string eventDir)
