...
using MeridianPinballClub.MeridianMash.Modes.Menu;
...
namespace MeridianPinballClub.MeridianMash.Modes
{
	...
	/// </summary>
    public class MeridianMashBaseGameMode : BaseGameMode
	{
		private MeridianMashButtonCombosMode buttonCombosMode;
		...
		public MeridianMashBaseGameMode (P3Controller controller)
			: base(controller)
		{

			MeridianMashBallLauncher.Initialize(controller, data);
            ...
            gameAttributeManagerMode = new MeridianMashGameAttributeManagerMode (p3, Priority);
			...
			attractMode = new MeridianMashAttractMode (p3, Priorities.PRIORITY_ATTRACT, "Attract");
			buttonCombosMode = new MeridianMashButtonCombosMode (p3, MeridianMashPriorities.PRIORITY_BUTTON_COMBOS);
			//mechManagerMode = new MeridianMashMechManager (p3, Priorities.PRIORITY_MECH);

			hudMode = new HUDMode (p3, Priorities.PRIORITY_MECH);
			popupMode = new PopupMode (p3, Priorities.PRIORITY_MECH);
			homeMode = new HomeMode (p3, MeridianMashPriorities.PRIORITY_HOME, "Home");
			introVideoMode = new IntroVideoMode (p3, MeridianMashPriorities.PRIORITY_HOME, "IntroVideo");
        ...
        protected override void InitializeGameData()
		{
			...
			Multimorphic.P3App.Data.DataManager.gameName = "MeridianMash";
		}
    ...
    public override void mode_stopped ()
		...
		protected override void RegisterSelectors() {
			...
			selectorManagerMode.RegisterSelector(new ProfileSettingsSelectorMode(p3, MeridianMashPriorities.PRIORITY_PROFILEATTRIBUTESELECTOR), "ProfileSettingsEditor", "Prefabs/Framework/ProfileSettingsEditor");
			...
			selectorManagerMode.RegisterSelector(new ConfirmationSelectorMode(p3, MeridianMashPriorities.PRIORITY_CONFIRMATION), "ConfirmationDialog", "Prefabs/Framework/ConfirmationDialog", true);
			selectorManagerMode.RegisterSelector(new ProfileSelectorMode(p3, MeridianMashPriorities.PRIORITY_PROFILESELECTOR), "ProfileDialog", "Prefabs/Framework/ProfileDialog", true);
			selectorManagerMode.RegisterSelector(new HighScoreNameSelectorMode(p3, MeridianMashPriorities.PRIORITY_HIGH_SCORE_NAME_SELECTOR), "HighScoreNameEntry", "Prefabs/Framework/HighScoreNameEntry", true);
			selectorManagerMode.RegisterSelector(new MeridianMashEventNameTextEditorMode(p3, MeridianMashPriorities.PRIORITY_EVENT_NAME_EDITOR), "EventNameEditor", "Prefabs/Framework/EventNameEditor", true);
			selectorManagerMode.RegisterSelector(new MeridianMashProfileNameTextEditorMode(p3, MeridianMashPriorities.PRIORITY_EVENT_NAME_EDITOR), "ProfileNameEditor", "Prefabs/Framework/ProfileNameEditor", true);
