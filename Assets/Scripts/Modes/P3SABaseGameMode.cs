...
namespace MeridianPinballClub.P3SA.Modes
{
	...
	/// </summary>
    public class P3SABaseGameMode : BaseGameMode
	{
		private P3SAButtonCombosMode buttonCombosMode;
			...
			: base(controller)
		{
			...
			P3SABallLauncher.Initialize(controller, data);
            ...
            gameAttributeManagerMode = new P3SAGameAttributeManagerMode (p3, Priority);
			...
			attractMode = new P3SAAttractMode (p3, Priorities.PRIORITY_ATTRACT, "Attract");
			buttonCombosMode = new P3SAButtonCombosMode (p3, P3SAPriorities.PRIORITY_BUTTON_COMBOS);
			//mechManagerMode = new P3SAMechManager (p3, Priorities.PRIORITY_MECH);

			hudMode = new HUDMode (p3, Priorities.PRIORITY_MECH);
			popupMode = new PopupMode (p3, Priorities.PRIORITY_MECH);
			homeMode = new HomeMode (p3, P3SAPriorities.PRIORITY_HOME, "Home");
			introVideoMode = new IntroVideoMode (p3, P3SAPriorities.PRIORITY_HOME, "IntroVideo");
        ...
        protected override void InitializeGameData()
		{
			...
			Multimorphic.P3App.Data.DataManager.gameName = "P3SA";
		}
    ...
    public override void mode_stopped ()
		...
		protected override void RegisterSelectors() {
			...
			selectorManagerMode.RegisterSelector(new ProfileSettingsSelectorMode(p3, P3SAPriorities.PRIORITY_PROFILEATTRIBUTESELECTOR), "ProfileSettingsEditor", "Prefabs/Framework/ProfileSettingsEditor");
			...
			selectorManagerMode.RegisterSelector(new ConfirmationSelectorMode(p3, P3SAPriorities.PRIORITY_CONFIRMATION), "ConfirmationDialog", "Prefabs/Framework/ConfirmationDialog", true);
			selectorManagerMode.RegisterSelector(new ProfileSelectorMode(p3, P3SAPriorities.PRIORITY_PROFILESELECTOR), "ProfileDialog", "Prefabs/Framework/ProfileDialog", true);
			selectorManagerMode.RegisterSelector(new HighScoreNameSelectorMode(p3, P3SAPriorities.PRIORITY_HIGH_SCORE_NAME_SELECTOR), "HighScoreNameEntry", "Prefabs/Framework/HighScoreNameEntry", true);
			selectorManagerMode.RegisterSelector(new P3SAEventNameTextEditorMode(p3, P3SAPriorities.PRIORITY_EVENT_NAME_EDITOR), "EventNameEditor", "Prefabs/Framework/EventNameEditor", true);
			selectorManagerMode.RegisterSelector(new P3SAProfileNameTextEditorMode(p3, P3SAPriorities.PRIORITY_EVENT_NAME_EDITOR), "ProfileNameEditor", "Prefabs/Framework/ProfileNameEditor", true);
