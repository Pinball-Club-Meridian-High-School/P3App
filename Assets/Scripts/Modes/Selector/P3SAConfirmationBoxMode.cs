...
namespace Multimorphic.P3SA.Modes.Menu
{
    ...
    public class P3SAConfirmationBoxMode : ConfirmationBoxMode
	{
		...
		public P3SAConfirmationBoxMode (P3Controller controller, int priority)
		...
		protected override void End()
		{
			base.End();
			active = false;
			Multimorphic.P3App.Logging.Logger.Log ("P3SAConfirmationBoxMode: End - Hiding button legend.");
