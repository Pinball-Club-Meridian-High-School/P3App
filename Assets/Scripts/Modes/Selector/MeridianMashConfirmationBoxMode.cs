...
namespace MeridianPinballClub.MeridianMash.Modes.Menu
{
    ...
    public class MeridianMashConfirmationBoxMode : ConfirmationBoxMode
	{
		Dictionary<string, string> legend;
		protected bool buttonAlreadyActive;
		protected bool active;

		public MeridianMashConfirmationBoxMode (P3Controller controller, int priority)
		...
		protected override void End()
		{
			base.End();
			active = false;
			Multimorphic.P3App.Logging.Logger.Log ("MeridianMashConfirmationBoxMode: End - Hiding button legend.");
