...
namespace MeridianPinballClub.P3SA.Modes
{
	...
	/// </summary>
	public static class P3SAPriorities
	{
        ...
        public const int PRIORITY_EVENT_NAME_EDITOR = P3SAPriorities.PRIORITY_TEXT_EDITOR + 1;
		public const int PRIORITY_HIGH_SCORE_NAME_SELECTOR = P3SAPriorities.PRIORITY_TEXT_EDITOR + 2;
