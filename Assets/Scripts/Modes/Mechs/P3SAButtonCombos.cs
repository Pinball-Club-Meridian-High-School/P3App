...
namespace MeridianPinballClub.P3SA.Modes
{
    ...
    public class P3SAButtonCombosMode : P3Mode
	{
		...
		public P3SAButtonCombosMode (P3Controller controller, int priority)
			: base(controller, priority)
		{
			Multimorphic.P3App.Logging.Logger.Log ("P3SAButtonCombosMode initialized");
