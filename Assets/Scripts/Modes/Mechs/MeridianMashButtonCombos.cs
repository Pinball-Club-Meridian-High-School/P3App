...
namespace MeridianPinballClub.MeridianMash.Modes
{
    ...
    public class MeridianMashButtonCombosMode : P3Mode
	{
		...
		public MeridianMashButtonCombosMode (P3Controller controller, int priority)
			: base(controller, priority)
		{
			Multimorphic.P3App.Logging.Logger.Log ("MeridianMashButtonCombosMode initialized");
